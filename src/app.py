...
activities = {
    ...
    "Tennis Club": {
        "description": "Tennis instruction and singles/doubles match play",
        "schedule": "Wednesdays and Saturdays, 3:00 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["sarah@mergington.edu", "alex@mergington.edu"]
    },
    "Art Studio": {
        "description": "Painting, drawing, and sculpture exploration for all skill levels",
    ...
    "Science Olympiad": {
        "description": "Science competitions covering biology, chemistry, physics, and engineering",
        "schedule": "Wednesdays and Saturdays, 3:00 PM - 4:30 PM",
        "max_participants": 20,
